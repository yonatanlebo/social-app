...
>(function ViewSelectorImpl(
  ...
  return (
    <FlatList_INTERNAL
      ...
      scrollIndicatorInsets={{right: 1}} // fixes a bug where the scroll indicator is on the middle of the screen http://192.168.0.49:8085/repository/github/bluesky-social/social-app/pull/464
    />
  )
})
